...
let tulipValue = tulipPrice * numberOfTulips;


let total = rosesValue + liliesValue + tulipValue; 
...
console.log("Tulip - unit price:", tulipPrice, ", quantity:", numberOfTulips, ", value:", tulipValue); 
